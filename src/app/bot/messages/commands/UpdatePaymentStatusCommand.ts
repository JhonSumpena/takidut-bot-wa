...
export const UpdatePaymentStatusCommand = {
  async execute(msg: Message): Promise<Message> {
    ...
    if (order_id === undefined || status_to_update === undefined) {
      return msg.reply(
        'Untuk memperbarui pembayaran, ketik *#bayar <id pesanan contoh: *5*> <status: pago atau pendente>* ❌',
      );
    }
    ...
    return msg.reply(
      'Status pembayaran berhasil diperbarui dan notifikasi telah dikirim! ✅',
    );
  },
};